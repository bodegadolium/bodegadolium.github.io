...
<img src="img/visitas.jpg" class="img-responsive">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 visitas" style="background:#dfd6c5;padding-left:0;padding-right:0;    padding: 30px;"> 

<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 borde-bottom" style="border-right:1px #504f4e solid;">
<h3>TOUR<br>
TOP VERTICAL</h3>
<h4>(45 - 60 MINUTOS DE DURACIÓN)</h4>
<img src="img/visitas-01.png" class="img-responsive" style="margin:40px 85px 0">
</div>

<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
<p><strong>Catas comparativas de terroir</strong> - nivel reservas <strong>Malbec</strong> pero de zonas más importantes para ver diferencias de terruños.<br>
<strong>Catas comparativas de Añada</strong> - la misma zona y tipo de elaboración pero diferentes años para aprender de evoluciones en los vinos.<br>
<strong>Catas comparativas de varietales</strong> de nuestra <strong>línea clásica</strong> y de nuestra nueva <strong>línea ecológica</strong>, con el objeto de aprender sobre <strong>características de cada varietal</strong> de mismo terroir y estilos de elaboración. Degustaciones  ocasional de diferentes estilos de <strong>vinos blancos:</strong> ligeros vs. con barrica, semi seco vs. dulce natural, y aromáticos. Comparamos 4 a 5 años de Malbec nivel Reserva antes y después del embotellado para descubrir el aporte del roble y cómo evoluciona con el tiempo.</p>
</div>
...
<h3>TOUR<br>
PREMIUM</h3>
<h4>(60 - 75 MINUTOS DE DURACIÓN)</h4>
<img src="img/visitas-01.png" class="img-responsive" style="margin:40px 85px 0">
</div>

<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
<p><strong>Cata vertical de tanques</strong>, de 4 años diferentes, de <strong>Malbec</strong> nivel Reserva destinado a nuetro <strong>Dolium Petit Reserva</strong>, antes y después de fraccionarlo. De este modo buscamos que el visitante vea la evolución de los vinos en el tiempo, a la par de apreciar como toma su bouquet en distintas etapas de su elaboración.<br>
<strong>Catas comparativas de terroir</strong> - nivel reservas Malbec pero de zonas mas importantes para ver diferencias de terruños Catas comparativas de varietales - de nuestra <strong>línea clásica</strong> y de nuestra nueva <strong>línea ecológica</strong>, con el objeto de aprender sobre características de cada varietal de mismo terroir y estilos de elaboración. En ocasiones hacemos degustaciones de diferentes estilos de vinos blancos: ligeros vs. con barrica, semi seco vs. dulce natural, y aromáticos.</p>
</div>
...
<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
<p>Incluye al <strong>Tour Top Vertical</strong> , junto a una cata guiada y explicación exhaustiva de <strong>barricas nuevas</strong> de vinos <strong>Reserva y Gran Reserva en roble americano y francés</strong>.<br>
Con el objetivo de apreciar el impacto diferencial de una madera y otra, sobre el mismo vino en añadas sucesivas de los lotes más privilegiados del mundo. Estos lotes han recibido premios tanto a nivel local como en Francia.
</p>
</div>
