...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 eventos" style="background:#afa59a;padding-left:0;padding-right:0;    padding: 30px;"> 
...
<h3>GRUPOS<br> 
& EVENTOS</h3>
<img src="img/bodega-eventos.png" class="img-responsive" style="display: inline-block;opacity: .6;margin-top: 40px;width: 45%;">
</div>

<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
<p><strong>Atención especializada a grupos , profesionales y amantes del vino</strong> con reserva.<br>
<strong>Full Day , Half Day , Grupos de Estudio</strong> y a medida. Grupos sin reserva sujetos a disponibilidad.<br><br>
<strong>Contamos con un lugar único para realizar eventos</strong> , ya sea entre las viñas con carpas especiales (con
capacidad ilimitada de personas ) <strong>ideal para casamientos, empresarial y lanzamientos</strong>, o para grupos reducidos
dentro de la comodidad de la bodega (ideal para hasta 15 y 45 personas ) <strong>con la mejor vista del viñedo y los
Andes</strong>.</strong>.
