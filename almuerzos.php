...
<img src="img/almuerzos.jpg" class="img-responsive">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 visitas" style="background:#dfc5a4;padding-left:0;padding-right:0;    padding: 30px;"> 

<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 almuerzo-box" style="border-right:1px #504f4e solid;height: 20vw;text-align:center;">
<h3>ALMUERZO<br> 
TRADICIONAL</h3>
<img src="img/bodega-almuerzos.png" class="img-responsive" style="display: inline-block;margin-top: 40px;opacity: .6;width: 45%;">
</div>

<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
<p>Almuerzos simples, de <strong>Tres Pasos</strong> y reservas previas. Ideal para poder compartir con los integrantes de la bodega mientras se reponen las energías maridando excelentes platos con una gran variedad de vinos. Queremos que los visitantes estén listos y activos para seguir degustando los vinos de otras bodegas vecinas que recomendaremos especialmente según sus inquietudes.<br>
<strong>En el corazón del camino del vino, entre Chandon y Tapiz</strong>.
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding-left:0px;padding-right:3px;">

<img src="img/almuerzo/almuerzos-01.jpg" class="img-responsive" style="display:inline-block;width:100%;">
</div>

<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding-left:1.6px;padding-right:1.6px;">
<img src="img/almuerzo/almuerzos-02.jpg" class="img-responsive" style="display:inline-block;width:100%;">
</div>

<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding-left:3px;padding-right:0px;">
<img src="img/almuerzo/almuerzos-03.jpg" class="img-responsive" style="display:inline-block;width:100%;">
</div>
...
<img src="img/almuerzo/almuerzos-04.jpg" class="img-responsive" style="display:inline-block;width:100%;">
</div>

<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding-left:1.6px;padding-right:1.6px;">
<img src="img/almuerzo/almuerzos-05.jpg" class="img-responsive" style="display:inline-block;width:100%;">
</div>

<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding-left:3px;padding-right:0px;">
<img src="img/almuerzo/almuerzos-06.jpg" class="img-responsive" style="display:inline-block;width:100%;">
</div>
